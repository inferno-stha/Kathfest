...
class MainApp:
    def __init__(self, root):
        ...
        self.students_data = [
            ("S001", "Aarav Sharma", "R101", "Computer Science", "5th"),
            ("S002", "Priya Nair", "R102", "Electronics", "3rd"),
            ("S003", "Rohan Gupta", "R103", "Computer Science", "5th"),
            ("S004", "Sneha Iyer", "R104", "Mechanical", "7th"),
            ("S005", "Karan Verma", "R105", "Civil", "1st"),
        ]
    ...
    def show_students(self):
        ...
        search_row = tk.Frame(wrapper, bg=styles.BACKGROUND_COLOR)
        search_row.pack(fill="x", pady=(0, 15))
        tk.Label(search_row, text="🔍", bg=styles.BACKGROUND_COLOR).pack(side="left", padx=(0, 5))
        self.search_var = tk.StringVar()
        search_entry = ttk.Entry(search_row, textvariable=self.search_var, font=styles.FONT_BODY)
    ...
    def _filter_students(self):
        ...
        rows = [r for r in self.students_data if query in r[1].lower() or query in r[0].lower()]
    ...
    def save_student(self):
        """Database Developer: open a form and INSERT a new student."""
        messagebox.showinfo("Add Student", "This feature is coming soon!")
    ...
    def mark_attendance(self):
        """Integration Developer: save a new attendance record after recognition."""
        messagebox.showinfo("Mark Attendance", "integration coming soon!")
